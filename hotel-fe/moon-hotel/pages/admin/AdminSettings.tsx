...
export const AdminSettings: React.FC = () => {
  const [activeTab, setActiveTab] = useState<"general" | "rooms" | "security">(
    "general",
  );
        ...
        <div className="flex-1 bg-white p-8 rounded-3xl border border-lux-200 shadow-sm">
          {activeTab === "general" && (
            <div className="space-y-6 animate-fade-in">
              <h2 className="text-xl font-bold text-lux-900 mb-6 pb-4 border-b border-lux-50">
                Thông tin khách sạn
              </h2>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                  <label className="block text-sm font-bold text-lux-700 mb-2">
                    Tên khách sạn
                  </label>
                  <input
                    type="text"
                    defaultValue="Moon Palace Hotel"
                ...
                <div>
                  ...
                  <input
                    type="email"
                    defaultValue="contact@moonpalace.com"
                    className="w-full p-3 bg-lux-50 border border-lux-200 rounded-xl outline-none focus:border-lux-500"
                  />
                </div>
                <div className="md:col-span-2">
                  ...
                  <input
                    type="text"
                    defaultValue="123 Đường Ánh Trăng, Quận 1, TP. Hồ Chí Minh"
                    className="w-full p-3 bg-lux-50 border border-lux-200 rounded-xl outline-none focus:border-lux-500"
                  />
                </div>
                <div>
          ...
          {activeTab === "rooms" && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="p-4 bg-yellow-50 border border-yellow-100 rounded-xl text-yellow-800 text-sm mb-6">
                Lưu ý: Thay đổi giá tại đây sẽ áp dụng cho tất cả các booking
                mới kể từ thời điểm lưu.
              </div>
              ...
              <div className="space-y-4">
                {["Suite", "Deluxe", "Standard", "Penthouse"].map((type) => (
                  <div
                    key={type}
                    className="flex items-center justify-between p-4 border border-lux-100 rounded-xl hover:bg-lux-50 transition-colors"
                  >
                    <div>
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <input
                        ...
                        className="w-24 p-2 border border-lux-200 rounded-lg text-right font-bold text-lux-900 outline-none focus:border-lux-500"
                      />
                    </div>
                  </div>
                ))}
          ...
          {activeTab === "security" && (
            <div className="space-y-6 animate-fade-in">
              ...
              <div className="pt-6 border-t border-lux-50">
                <h3 className="font-bold text-lux-900 mb-4 flex items-center gap-2">
                ...
                <div className="flex items-center justify-between p-4 border border-lux-100 rounded-xl">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-6 bg-blue-600 rounded text-white text-[8px] flex items-center justify-center font-bold">
                      VNPay
                    </div>
                ...
                <div className="flex items-center justify-between p-4 border border-lux-100 rounded-xl mt-3">
                  <div className="flex items-center gap-3">
                    <div className="w-10 h-6 bg-yellow-400 rounded text-blue-800 text-[8px] flex items-center justify-center font-bold">
                      PAYPAL
                    </div>
          ...
          <div className="pt-8 border-t border-lux-50 mt-8 flex justify-end gap-3">
            <button className="px-6 py-3 text-lux-600 font-bold hover:bg-lux-50 rounded-xl transition-colors">
              Hủy bỏ
            </button>
            <button
              onClick={handleSave}
