...
// Use RoomResponse instead of Room to match API data structure
import { RoomResponse, GuestInfo } from "../types";
...
export const BookingPage: React.FC = () => {
  ...
  // Fix: changed state type to RoomResponse to include typeDisplay and other API fields
    ...
    const fetchRoom = async () => {
      try {
        ...
        if (response.data.status === "success") {
          // Fix: setRoom now accepts RoomResponse
    ...
    try {
      ...
      setError(
        err.response?.data?.message ||
          "Có lỗi xảy ra trong quá trình đặt phòng.",
      );
    } finally {
      setSubmitting(false);
    }
      ...
      <div className="min-h-screen bg-slate-50 pt-24 flex items-center justify-center px-4 animate-fade-in">
        <div className="bg-white p-8 md:p-12 rounded-3xl shadow-xl text-center max-w-lg w-full border border-slate-100 relative overflow-hidden">
          ...
          <p className="text-slate-600 mb-8 text-sm">
            Cảm ơn bạn đã lựa chọn Moon Palace. Thông tin chi tiết đã được gửi
            tới email <b>{guestInfo.email}</b>.
          </p>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            >
              ...
              <div className="p-6 md:p-8 border-b border-slate-100 bg-slate-50/50">
                <h3 className="text-xl font-bold text-slate-900 mb-6 flex items-center gap-2">
                  <Calendar size={20} className="text-indigo-500" /> Chi tiết
                  lưu trú
                </h3>
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <select
                      ...
                      className="w-full p-3 bg-white border border-slate-200 rounded-xl outline-none focus:ring-2 focus:ring-indigo-100 focus:border-indigo-500 transition-all font-medium text-slate-700 cursor-pointer"
                    >
                      {Array.from(
              ...
              <div className="p-6 md:p-8">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mb-6">
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        type="text"
                        className="w-full pl-10 pr-3 py-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-indigo-500 focus:bg-white transition-all font-medium"
                  ...
                  <div className="space-y-2">
                    ...
                    <input
                      name="cccdNumber"
                      value={guestInfo.cccdNumber}
                      onChange={handleGuestInfoChange}
                      type="text"
                      className="w-full p-3 bg-slate-50 border border-slate-200 rounded-xl outline-none focus:border-indigo-500 focus:bg-white transition-all font-medium"
              ...
              <div className="p-6 md:p-8 bg-slate-50 border-t border-slate-100">
                <div className="flex items-start gap-3 mb-6">
                  ...
                  <p className="text-sm text-slate-600">
                    Bằng việc chọn "Xác nhận đặt phòng", bạn đồng ý với các điều
                    khoản và quy định của Moon Palace. Đơn đặt phòng sẽ được giữ
                    trong 24h chờ thanh toán.
                  </p>
                </div>
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-6 rounded-3xl shadow-lg shadow-slate-200/50 border border-slate-100 sticky top-24">
              <h3 className="font-serif font-bold text-slate-900 text-xl mb-6">
                Tóm tắt đơn phòng
              </h3>
              ...
              <div className="space-y-4 mb-6 border-t border-b border-slate-50 py-6">
                ...
                <div className="flex justify-between text-slate-600 text-sm">
                  ...
                  <span className="font-medium font-mono">
                    {serviceCharge.toLocaleString()} VND
                  </span>
                </div>
              </div>
              ...
              <div className="flex justify-between items-end mb-2">
                ...
                <span className="text-2xl  font-bold text-indigo-600">
                  {total.toLocaleString()}
                    <span className="text-xs text-indigo-400 ml-2">VND</span>
                </span>
              </div>
