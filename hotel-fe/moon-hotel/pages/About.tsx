  ...
  const milestones = [
    {
      ...
      img: "https://images.unsplash.com/photo-1678913308053-316cee77afe9?q=80&w=1170&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      year: "2020",
      ...
      img: "https://images.unsplash.com/photo-1534600449025-f819812e82d4?q=80&w=687&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      year: "2022",
      title: "Michelin Key Award",
      desc: "Nhà hàng Moonlight vinh dự nhận 1 sao Michelin đầu tiên cho thực đơn Fusion Á - Âu.",
      img: "https://images.unsplash.com/photo-1564759296729-771e78c26df7?q=80&w=764&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
    {
      year: "2023",
      ...
      img: "https://images.unsplash.com/photo-1571896349842-33c89424de2d?q=80&w=880&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D",
    },
  ];
    ...
    <div className="min-h-screen bg-lux-50 font-sans pt-20 animate-fade-in pb-20">
      ...
      <div className="relative h-[60vh] flex items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-4 max-w-4xl">
          ...
          <p className="text-lux-100 text-lg md:text-xl font-bold">
            Hành trình kiến tạo không gian nghỉ dưỡng yên tĩnh dưới ánh trăng
          </p>
        </div>
      </div>
      ...
      <section className="py-20 px-6 max-w-7xl mx-auto">
        <div className="grid grid-cols-1 md:grid-cols-2 gap-16 items-center">
          <div>
            <span className="text-lux-500 font-bold uppercase tracking-widest text-sm">
              Về Moon Light Hotel
            </span>
            <h2 className="text-4xl font-serif font-bold text-lux-900 mt-2 mb-6">
              Nơi sang trọng trở thành tiêu chuẩn
            </h2>
            <p className="text-lux-600 mb-6 leading-relaxed">
              Được thành lập vào năm 2015, Moon Light không chỉ là một khách
              sạn, mà là biểu tượng của sự thanh lịch và tinh tế. Lấy cảm hứng
              từ vẻ đẹp huyền bí và êm dịu của ánh trăng, chúng tôi tạo ra một
              không gian nơi thời gian như ngừng lại.
            </p>
            <p className="text-lux-600 mb-6 leading-relaxed">
              Sứ mệnh của chúng tôi là mang đến cho du khách những trải nghiệm
              vượt trên cả sự mong đợi, kết hợp giữa kiến trúc đương đại và dịch
              vụ tận tâm chuẩn mực quốc tế.
            </p>
          ...
          <div className="relative">
            <img
              ...
              alt="Interior"
              className="rounded-3xl shadow-2xl z-10 relative border border-lux-100"
            />
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <p className="text-lux-200 mb-6 leading-relaxed">
                Tại MoonLight, chúng tôi tin rằng món ăn ngon bắt đầu từ nguyên
                liệu sạch. Các đầu bếp của chúng tôi hợp tác trực tiếp với các
                nông trại hữu cơ địa phương để mang đến những hương vị tươi mới
                nhất mỗi ngày.
              </p>
              <button
            ...
            <div className="grid grid-cols-2 gap-4">
              ...
              />
              <img
                src="https://plus.unsplash.com/premium_photo-1694715585704-81111d19074d?q=80&w=2070&auto=format&fit=crop&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D"
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-6 text-center">
          <span className="text-lux-500 font-bold uppercase tracking-widest text-sm block mb-4">
            Đội ngũ lãnh đạo
          </span>
          <h2 className="text-4xl font-serif font-bold text-lux-900 mb-16">
            Những người kiến tạo giấc mơ
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            {[
              ...
              },
              {
                ...
                img: "../image/general_manager.jpg",
              },
              {
                name: "Mason Nguyễn",
                role: "Head Chef",
                img: "../image/master_chef-8481.jpg",
              },
            ].map((member, idx) => (
              <div key={idx} className="group cursor-pointer">
                ...
                <h3 className="text-xl font-bold text-lux-900 mb-1">
                  {member.name}
                </h3>
                <p className="text-lux-500 text-sm font-medium">
                  {member.role}
                </p>
              </div>
            ))}
      ...
      <section className="py-20 bg-lux-50 border-t border-lux-100">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-serif font-bold text-lux-900">
              Giải thưởng & Thành tựu
            </h2>
            <p className="text-lux-500 mt-4">
              Sự công nhận cho những nỗ lực không ngừng nghỉ
            </p>
          </div>
            ...
            <div className="space-y-12 md:space-y-24">
              {milestones.map((item, index) => (
                ...
                >
                  ...
                  {/* Text Side */}
                  <div
                    className={`w-full md:w-1/2 pl-12 md:pl-0 md:px-12 ${index % 2 === 0 ? "md:text-left" : "md:text-right"}`}
                  >
                    <span className="text-6xl font-serif font-bold text-lux-100 absolute -z-10 -mt-10 select-none opacity-50">
                      {item.year}
                    </span>
                    <span className="text-lux-500 font-bold text-xl block mb-2 relative">
                      {item.year}
                    </span>
                    <h3 className="text-2xl font-bold text-lux-900 mb-3">
                      {item.title}
                    </h3>
        ...
        <div className="max-w-7xl mx-auto px-6">
          <div className="flex justify-between items-end mb-12">
            <div>
              ...
              <h2 className="text-4xl font-serif font-bold text-lux-900 mt-2">
                Góc nhìn MoonLight
              </h2>
            </div>
            ...
            {[
              {
                ...
                desc: "Mọi chi tiết nhỏ nhất đều được chăm chút kỹ lưỡng.",
              },
              {
                icon: Heart,
                title: "Tận tâm",
                desc: "Phục vụ khách hàng bằng cả trái tim và sự thấu hiểu.",
              },
              {
                icon: Shield,
                title: "Riêng tư",
                desc: "Đảm bảo sự an toàn và không gian riêng tư tuyệt đối.",
              },
              {
                icon: Clock,
                title: "Sẵn sàng 24/7",
                desc: "Luôn có mặt bất cứ khi nào bạn cần.",
              },
            ].map((item, idx) => (
              <div
                key={idx}
                className="text-center p-8 rounded-2xl bg-white hover:shadow-xl hover:-translate-y-1 transition-all duration-300 border border-lux-100"
              >
                ...
                <h3 className="text-xl font-bold text-lux-900 mb-3">
                  {item.title}
                </h3>
