      ...
      <div className="min-h-screen bg-slate-50 pt-24 pb-20 flex items-center justify-center px-4 animate-fade-in">
        <div className="bg-white w-full max-w-lg p-8 rounded-3xl shadow-xl text-center border border-slate-100">
          ...
          <p className="text-slate-500 mb-8">
            Cảm ơn bạn đã thanh toán cho đơn đặt phòng{" "}
            <strong>#{booking.bookingNumber}</strong>. Hóa đơn điện tử đã được
      ...
      <div className="max-w-6xl mx-auto px-4 md:px-6">
        ...
        <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
          ...
          <div className="flex items-center gap-2 px-3 py-1.5 bg-white border border-slate-200 rounded-lg text-sm text-slate-500 font-medium">
            <ShieldCheck size={16} className="text-emerald-500" /> Thanh toán
            bảo mật
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
              ...
              {selectedMethod === "CREDIT_CARD" && (
                <form onSubmit={handleProcessPayment} className="space-y-6">
                  ...
                  >
                    ...
                    {processing
                      ? "Đang xử lý..."
                      : `Thanh toán ${booking.totalAmount.toLocaleString()}đ`}
                  </button>
                  <p className="text-center text-xs text-slate-400 mt-4 flex items-center justify-center gap-1">
                    <ShieldCheck size={12} /> Giao dịch được bảo mật và mã hóa
                    SSL 256-bit
                  </p>
                </form>
              )}
                  ...
                  <div className="text-left bg-indigo-50 p-6 rounded-2xl space-y-3 border border-indigo-100">
                    ...
                    <div className="flex justify-between items-center pt-2 border-t border-indigo-200">
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        <button
                          onClick={() =>
                            handleCopy(booking.bookingNumber, "content")
                          }
                          className="text-indigo-600 hover:text-indigo-800 relative"
                        >
                          {copied === "content" ? (
              ...
              {selectedMethod === "E_WALLET" && (
                <div className="text-center py-12">
                  ...
                  <p className="text-slate-500 font-medium">
                    Đang kết nối với cổng thanh toán ví điện tử...
                  </p>
                  <button
                    onClick={handleProcessPayment}
                    disabled={processing}
          ...
          <div className="lg:col-span-1">
            <div className="bg-white p-6 rounded-3xl shadow-lg shadow-slate-200/50 border border-slate-100 sticky top-24">
              <h3 className="font-bold text-slate-900 text-xl mb-6 font-serif">
                Thông tin đơn phòng
              </h3>
                    ...
                    <img
                      ...
                      onError={(e) => {
                        ...
                        e.currentTarget.parentElement!.innerHTML =
                          '<div class="w-full h-full flex items-center justify-center text-slate-300 bg-slate-100 font-bold text-xs">IMG</div>';
                      }}
                    />
                  ) : (
