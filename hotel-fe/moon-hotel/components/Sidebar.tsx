      ...
      <div>
        ...
        >
          ...
          <div className="flex items-baseline gap-1">
            <span className="text-xl font-serif font-bold text-lux-900 leading-none">
              Moon
        ...
        <nav className="space-y-1">
          <div className="mb-6">
            <div className="px-4 py-2 text-xs font-bold text-lux-400 uppercase tracking-wider">
              Lối tắt
            </div>
            <button
              onClick={() => navigate("/")}
          ...
          {user.role === Role.ADMIN ? (
            <>
              <div className="px-4 py-2 text-xs font-bold text-lux-400 uppercase tracking-wider mt-4">
                Quản trị
              </div>
