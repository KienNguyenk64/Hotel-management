...
export const Rooms: React.FC = () => {
  ...
  const [priceSort, setPriceSort] = useState<"asc" | "desc" | "default">(
    "default",
  );
  ...
  const selectedPriceLabel =
    PRICE_RANGES.find((r) => r.value === priceRange)?.label || "Tất cả";
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 lg:gap-8 mb-12">
              {rooms.map((room, index) => (
                ...
                >
                  ...
                  {/* Content */}
                  <div className="p-6">
                    <h3 className="text-xl font-serif font-bold mb-3 group-hover:text-blue-600 transition-colors">
                      {room.name}
                    </h3>
                    ...
                    <div className="flex flex-col gap-2 pt-4 border-t-2 border-gray-100">
                      ...
                      <span className="text-xs text-gray-500">
                        ≈ ${formatUSD(room.pricePerNight).toLocaleString()}
                      </span>
