...
export const UserProfile: React.FC = () => {
  ...
  const handleUploadAvatar = async (file: File) => {
    ...
    try {
      ...
      showNotification(error.response?.data?.message || 'Upload avatar thất bại', 'error');
  ...
  const handleDeleteAvatar = async () => {
    ...
    try {
      ...
      showNotification('Không thể xóa avatar', 'error');
    } finally {
      setIsUploadingAvatar(false);
    }
  };
  ...
  if (!user) return null;
  const avatarUrl = avatarPreview || user.avatarUrl || `https://ui-avatars.com/api/?name=${encodeURIComponent(user.fullName)}&background=0F172A&color=fff&bold=true`;
        ...
        <div className="max-w-6xl mx-auto px-4 md:px-8 relative z-10">
            <div className="flex flex-col md:flex-row items-center md:items-end gap-8 mb-8">
                ...
                <div className="relative group">
                    ...
                    <div className="absolute inset-0 rounded-full bg-black/0 group-hover:bg-black/60 transition-all duration-300 flex items-center justify-center gap-2 opacity-0 group-hover:opacity-100">
                        <input 
                          ref={avatarInputRef}
                          type="file" 
                          accept="image/*"
                        ...
                        <button 
                          ...
                          className="p-2 bg-white rounded-full shadow-lg hover:bg-indigo-50 transition-colors disabled:opacity-50"
                          title="Tải ảnh lên"
                        >
                        ...
                        {user.avatarUrl && (
                          <button 
                            ...
                            disabled={isUploadingAvatar}
                            className="p-2 bg-white rounded-full shadow-lg hover:bg-rose-50 transition-colors disabled:opacity-50"
                            title="Xóa avatar"
                          >
                    ...
                    <div className="absolute bottom-1 right-1 p-2 bg-emerald-500 rounded-full border-4 border-[#0B1120] shadow-sm">
                            ...
                            <div className="bg-white rounded-3xl p-8 shadow-sm border border-slate-100">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative">
                                            <input type="text" value={profile.username} disabled className="w-full p-3 pl-10 bg-slate-50/50 rounded-xl border border-slate-200 text-sm font-bold text-slate-400 cursor-not-allowed"/>
                                    ...
                                    <div className="space-y-1.5">
                                        ...
                                        <div className="relative">
                                            <input type="email" value={profile.email} disabled className="w-full p-3 pl-10 bg-slate-50/50 rounded-xl border border-slate-200 text-sm font-bold text-slate-400 cursor-not-allowed"/>
                             ...
                             <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 h-full">
                                ...
                                <form onSubmit={handleChangePassword} className="space-y-4">
                                    <div className="space-y-1.5">
                                        ...
                                        <input type="password" value={passwordForm.oldPassword} onChange={e => setPasswordForm({...passwordForm, oldPassword: e.target.value})} className="w-full p-3 bg-slate-50 rounded-xl border border-slate-200 text-sm outline-none focus:border-rose-300 transition-all"/>
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-bold text-slate-400 uppercase">Mật khẩu mới</label>
                                        <input type="password" value={passwordForm.newPassword} onChange={e => setPasswordForm({...passwordForm, newPassword: e.target.value})} className="w-full p-3 bg-slate-50 rounded-xl border border-slate-200 text-sm outline-none focus:border-rose-300 transition-all"/>
                                    </div>
                                    <div className="space-y-1.5">
                                        <label className="text-[10px] font-bold text-slate-400 uppercase">Xác nhận mật khẩu</label>
                                        <input type="password" value={passwordForm.confirmPassword} onChange={e => setPasswordForm({...passwordForm, confirmPassword: e.target.value})} className="w-full p-3 bg-slate-50 rounded-xl border border-slate-200 text-sm outline-none focus:border-rose-300 transition-all"/>
                                    </div>
