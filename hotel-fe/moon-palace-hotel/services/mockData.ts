...
export const ROOM_DATA: Room[] = [
  ...
  },
  {
    ...
    amenities: ["Wifi", "TV", "Minibar", "Bathtub"],
    images: [
      "https://images.unsplash.com/photo-1631049552057-403cdb8f0658?q=80&w=1000&auto=format&fit=crop",
    ],
    thumbnailImage:
      "https://images.unsplash.com/photo-1631049552057-403cdb8f0658?q=80&w=1000&auto=format&fit=crop",
    status: RoomStatus.AVAILABLE,
...
export const REVIEWS_DATA: Review[] = [
  {
    ...
    rating: 5,
    comment:
      "Một trải nghiệm tuyệt vời! Cảnh đêm từ phòng Moonlight Suite thực sự ngoạn mục.",
    date: "2023-10-10",
    status: "Approved",
...
export const MENU_ITEMS: MenuItem[] = [
  {
    ...
    image:
      "https://images.unsplash.com/photo-1547592166-23acbe3a624b?q=80&w=600&auto=format&fit=crop",
    isChefChoice: true,
  },
];
...
export const BLOG_POSTS: BlogPost[] = [
  ...
  {
    id: "2",
    title: "Top 5 khách sạn sang trọng nhất năm 2026",
    excerpt:
      "Khám phá những khách sạn đẳng cấp thế giới với dịch vụ và kiến trúc tuyệt vời.",
  ...
  {
    id: "3",
    title: "Kinh nghiệm đặt phòng giá rẻ mà vẫn chất lượng",
    excerpt:
  ...
  {
    id: "4",
    title: "Xu hướng thiết kế phòng khách sạn hiện đại",
    excerpt:
